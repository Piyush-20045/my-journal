...
const PrivateJournals = () => {
  const { user } = useAuth();
  const { filteredJournals } = useSearch();
  ...
  return (
    <div>
      <div className="w-full h-full lg:px-40 pt-6 pb-10 bg-gradient-to-b from-slate-400 to-stone-200">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex items-center mr-1">
            <NavLink
              ...
              className={({ isActive }) =>
                `px-3 py-2 rounded-l-md ${
                  isActive
                    ? "text-white bg-blue-800 shadow shadow-black"
                    : "bg-white"
                }`
              }
            >
            ...
            <NavLink
              to="/public-journals"
              className={({ isActive }) =>
                `px-3 py-2 rounded-r-md font-semibold ${
        ...
        <div className="md:pl-2 flex justify-center flex-wrap sm:space-x-3 space-y-4">
          {filteredJournals.length > 0 ? (
            filteredJournals.map((journal) => (
              ...
              >
                ...
                {/* IMAGE */}
                <img
                  className="pt-2 pl-2 my-2 mx-auto w-60 rounded"
